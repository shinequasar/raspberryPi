...
void turnOnLEDMatrix(int pattern){
    ...
    switch(pattern){
        case 1 : //하트
            ...
            break;
        case 2 : 
            turnOn[9][9] ={ {0, 0, 56, 124, 0, 0, 68, 0, 0 }, 
            ...
            break;  
        case 3 : 
            turnOn[9][9] ={ {0, 16, 23, 124, 43, 1, 2, 0, 0 }, 
                { 16, 56, 124, 254, 238, 68, 0, 0 ,0 },
            ...
            break; 
        case 4 : 
            turnOn[9][9] ={ {0, 6, 4, 4, 54, 38, 8, 0, 0 }, 
                { 16, 56, 124, 254, 238, 68, 0, 0 ,0 },
            ...
            break; 
        case 5 : 
            turnOn[9][9] ={ {0, 10, 0, 94, 0, 0, 0, 0, 0 }, 
                { 16, 56, 124, 254, 238, 68, 0, 0 ,0 },
                { 56, 124, 254, 238, 68, 0, 0 ,0, 16 },
                { 124, 254, 238, 68, 0, 0 ,0, 16 ,56 },
                { 254, 238, 68, 0, 0 ,0, 16 ,56 ,124 },
                { 238, 68, 0, 0 ,0, 16 ,56 ,124, 254 },
                { 68, 0, 0 ,0, 16 ,0 ,124, 254, 238 },
                { 0, 0 ,0, 16 ,56 ,124, 254, 238, 68 },
                { 0, 0, 0, 0, 0, 0, 0, 0, 0 }}; 
            break; 
        default :
